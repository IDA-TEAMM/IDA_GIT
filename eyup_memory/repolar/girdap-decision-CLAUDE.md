...
> **Amaç:** Otonomi Kabiliyeti videosu gerçek suda; senaryo = 4 GPS waypoint
> dikdörtgen + başlangıca dönüş. Karmaşık füzyon/planlama katmanları **bypass**
> edilip en sade güvenilir zincir kullanılır. Yarışma günü tam stack açılır.
...
3. `P1_return = P1` (başlangıca dönüş kapanışı).
