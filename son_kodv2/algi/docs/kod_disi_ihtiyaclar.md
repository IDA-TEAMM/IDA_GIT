...
| Ne | Neden | Durum |
|---|---|---|
| 🟠 Model: `yolo11n_duba_rvc2.blob` **+ `config.json`** (⚠️ NN Archive `.tar.xz` DEĞİL — depthai 2.30 açamaz) | YOLO'nun VPU'da koşan hali — kamera tespiti onsuz YOK | Üretilecek: [`hubai_model_rehberi.md`](hubai_model_rehberi.md) — 512×512, **4 shave**, `superblob=False` |
