...
|---|---|---|
| (1) İDA↔YKİ kablosuz; İDA bilgisi YKİ'de | §3.2 QGC bağlantısı | QGC ↔ RFD868x ↔ Pixhawk (MAVROS'tan bağımsız kanal) |
...
(RFD868x MAVLink taşır, IP taşımaz) → md 3.3.1(3) "YKİ/RC'den komutla
...
(`fsm_node:311`), QGC'nin arm butonu RFD868 üzerinden yeter.
...
- [ ] QGC ↔ RFD868x ↔ Pixhawk zinciri masada teyit: telemetri görünüyor,
