...
bas "1/7 — SERVİSLER: kurulu + enabled mi"
...
bas "2/7 — VERİ SETİ AYARLARI (kaptan: 1 sn/kare, ~/veri_seti, algı otomatik dönüş)"
...
bas "3/7 — KARAR SERVİSİ: LiDAR bağımlılığı + overlay"
...
bas "4/7 — KOD SÜRÜMÜ: yığın HANGİ kopyayı koşuyor"
...
bas "5/7 — PIXHAWK: udev symlink + fcu_url uyumu"
...
bas "6/7 — PYTHON ORTAMI (iSAM2/GTSAM için kritik)"
...
bas "7/7 — SAAT (Dosya-1/2/3 zaman etiketleri buna bağlı)"
date '+     şu an: %F %T %Z'
