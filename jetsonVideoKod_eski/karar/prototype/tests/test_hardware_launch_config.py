...
def test_video_bloklari_yamldan_okunur() -> None:
    ...
    # BULGU 2 — kaynak susunca sütun boşalmalı (donuk değer = sahte canlı veri).
    # Bekçi AÇIK olmalı: >0. 8 Hz TELEM2 hattında 3 s ≈ 24 kayıp mesaj.
    assert cfg["telemetry"]["source_timeout_s"] > 0.0
