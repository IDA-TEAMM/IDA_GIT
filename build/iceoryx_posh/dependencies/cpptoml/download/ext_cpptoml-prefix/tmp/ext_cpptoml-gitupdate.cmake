...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/ros2_ws/build/iceoryx_posh/dependencies/cpptoml/src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/ros2_ws/build/iceoryx_posh/dependencies/cpptoml/src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
