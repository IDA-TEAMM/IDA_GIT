    ...
    try:
        ...
        for key in _TELEMETRY_DEFAULTS:
            if key in telemetry_block:
                cfg["telemetry"][key] = telemetry_block[key]
...
def generate_launch_description() -> LaunchDescription:
    ...
    # auto_guided: AUTO video koşusunda false ŞART — köprü görev sırasında modu
    # GUIDED'a zorlayıp FC'yi AUTO görevinden atardı (mod savaşı, B1).
    bridge_params = [
        params_file,
        {
