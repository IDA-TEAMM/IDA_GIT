...
**GitHub (2026-07-14):** son_kod → **https://github.com/yahyaseha/girdap-kaptan-video** (PRIVATE ✓, push edildi; gh CLI `yahyaseha` olarak girişli). Collaborator davetleri: `gh api -X PUT repos/yahyaseha/girdap-kaptan-video/collaborators/<kullanıcı>`.
