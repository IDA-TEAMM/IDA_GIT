...
4. **Dosya-1 kamera mp4: KAPANDI (14.07)** — `kamera_kayit_node` (ida_topics, artık son_kod'da) bbox overlay + zaman etiketli mp4'ü ~/girdap_logs/kamera'ya yazar; with_drivers:=true ile başlar. KALAN: lidar için ayrı mp4 (Dosya-1b, 'her sensör tipi için ayrı') üreticisi hâlâ yok — final öncesi yazılmalı.
