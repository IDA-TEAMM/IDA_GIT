...
_BRIDGE_DEFAULTS: dict[str, tuple[object, type]] = {
    ...
    "mode_retry_interval_s": (2.0, float),  # F-M.4: mod isteği retry aralığı
}
_TELEMETRY_DEFAULTS: dict[str, tuple[object, type]] = {
    ...
    "source_timeout_s": (3.0, float),   # BULGU 2: kaynak-tazelik bekçisi
}
...
_FUSION_DEFAULTS: dict[str, tuple[object, type]] = {
    ...
    "sync_slop_s": (0.3, float),                 # F-L.2: Livox ~0.2 s geride + pay
    "log_period_s": (5.0, float),
}
...
def generate_launch_description() -> LaunchDescription:
    ...
    bridge_params = [
        params_file,
        {
            ...
            "mode_retry_interval_s": float(
                hw["bridge"]["mode_retry_interval_s"]
            ),
    ...
    telemetry_params = [
        params_file,
        {
            ...
            "source_timeout_s": float(hw["telemetry"]["source_timeout_s"]),
        },
    ]
